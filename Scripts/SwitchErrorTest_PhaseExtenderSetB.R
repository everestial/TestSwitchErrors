...
png("data/rplots/SwitchPoints_SetB_withOutHaplotypeBreaks.png", width = 1600, height = 600)
...
png("data/rplots/SwitchPoints_SetB_includingHaplotypeBreaks.png", width = 1600, height = 600)
...
png("data/rplots/Histogram_ofHaplotypeSizeDistribution_SetB.png", width = 1600, height = 600)
...
png("data/rplots/DensityPlot_ofHaplotypeSizeDistribution_SetB.png", width = 1600, height = 600)
